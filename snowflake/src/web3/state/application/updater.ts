import useDebounce from 'web3/hooks/useDebounce'
import useIsWindowVisible from 'web3/hooks/useIsWindowVisible'
import { useActiveWeb3React } from 'web3/hooks/web3'
import { useCallback, useEffect, useState } from 'react'
import { api, CHAIN_TAG } from 'web3/state/data/enhanced'
import { useAppDispatch, useAppSelector } from 'web3/state/hooks'
import { supportedChainId } from 'web3/utils/supportedChainId'
