...
import { PrivacyPolicyModal } from 'web3/components/PrivacyPolicy'
import { L2_CHAIN_IDS } from 'web3/constants//chains'
import { LOCALE_LABEL, SUPPORTED_LOCALES, SupportedLocale } from 'web3/constants//locales'
import { useActiveLocale } from 'web3/hooks/useActiveLocale'
import { useLocationLinkProps } from 'web3/hooks/useLocationLinkProps'
