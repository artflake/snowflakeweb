...
import {
  ...
  SupportedChainId,
  SupportedL2ChainId,
} from 'web3/constants//chains'
import { useOnClickOutside } from 'web3/hooks/useOnClickOutside'
import { useActiveWeb3React } from 'web3/hooks/web3'
import { useCallback, useRef } from 'react'
import { ArrowDownCircle, ChevronDown } from 'react-feather'
import { useModalOpen, useToggleModal } from 'web3/state/application/hooks'
import { ApplicationModal } from 'web3/state/application/reducer'
import { useAppSelector } from 'web3/state/hooks'
import styled from 'styled-components/macro'
import { ExternalLink, MEDIA_WIDTHS } from 'web3/theme'
import { switchToNetwork } from 'web3/utils/switchToNetwork'
