import { CHAIN_INFO } from 'web3/constants//chains'
import useCurrentBlockTimestamp from 'web3/hooks/useCurrentBlockTimestamp'
import useMachineTimeMs from 'web3/hooks/useMachineTime'
import { useActiveWeb3React } from 'web3/hooks/web3'
import ms from 'ms.macro'
import { useEffect, useState } from 'react'
import { useBlockNumber } from 'web3/state/application/hooks'
import styled, { keyframes } from 'styled-components/macro'
import { ExternalLink, ThemedText } from 'web3/theme'
import { ExplorerDataType, getExplorerLink } from 'web3/utils/getExplorerLink'
