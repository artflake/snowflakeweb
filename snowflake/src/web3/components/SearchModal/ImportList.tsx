...
import { ButtonPrimary } from 'web3/components/Button'
import Card from 'web3/components/Card'
import { AutoColumn } from 'web3/components/Column'
import ListLogo from 'web3/components/ListLogo'
import { AutoRow, RowBetween, RowFixed } from 'web3/components/Row'
import { SectionBreak } from 'web3/components/swap/styleds'
import { useFetchListCallback } from 'web3/hooks/useFetchListCallback'
import useTheme from 'web3/hooks/useTheme'
import { transparentize } from 'polished'
import { useCallback, useState } from 'react'
import { AlertTriangle, ArrowLeft } from 'react-feather'
import ReactGA from 'react-ga'
import { useAppDispatch } from 'web3/state/hooks'
import { enableList, removeList } from 'web3/state/lists/actions'
import { useAllLists } from 'web3/state/lists/hooks'
import styled from 'styled-components/macro'
import { CloseIcon, ThemedText } from 'web3/theme'
