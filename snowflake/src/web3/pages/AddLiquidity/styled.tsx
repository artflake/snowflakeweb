...
import CurrencyInputPanel from 'web3/components/CurrencyInputPanel'
import Input from 'web3/components/NumericalInput'
import { BodyWrapper } from 'web3/pages/AppBody'
